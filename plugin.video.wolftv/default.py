...
#mensaje CHAMPIONS LEAGUE Y LA LIGA
__addon__ = xbmcaddon.Addon()
__addonname__ = __addon__.getAddonInfo('name')
__icon__ = __addon__.getAddonInfo('icon')
 
line1 = "  ------BIENVENIDOS A [COLOR blue]...*WOLF TV*...[/COLOR]DISFRUTA DE LA MEJOR PROGRAMACION AUN BAJO COSTO ....."

line2 = "  !![COLOR red][B]!! AVISO !![/B][/COLOR] Tu SUBSCRIPCION  PREMIUM  esta proximo a vencer.. "

line3 = "  !![COLOR red][B]!! AVISO !![/B][/COLOR] Tu SUBSCRIPCION  PREMIUM  esta proximo a vencer.. "

time = 29000 #in miliseconds
...
Base = 'https://dl.dropbox.com/s/ctc60fgcon4t61j/MASTER%20142.XML' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.WolfTV') #    modificar("el nombre de tu addons")
